...
describe('usageEntryToPosthogEvent', () => {
  ...
  it('incluye nombre de compañía y URLs de sandbox', () => {
    const ev = usageEntryToPosthogEvent({
      ...
      leftOrgId: 'L',
      rightOrgId: 'R',
      leftCompanyName: 'CaixaBank DEV',
      rightCompanyName: 'CaixaBank UAT',
      leftInstanceUrl: 'https://caixa--dev.sandbox.my.salesforce.com',
      rightInstanceUrl: 'https://caixa--uat.sandbox.my.salesforce.com',
      leftIsSandbox: true,
      rightIsSandbox: true
    });
    expect(ev?.properties.left_company_name).toBe('CaixaBank DEV');
    expect(ev?.properties.right_company_name).toBe('CaixaBank UAT');
